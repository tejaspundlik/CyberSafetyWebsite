...
echo "<div class='heading'><h1>The Current Existing Questions Are</h1></div>";
$servername = "sql12.freemysqlhosting.net";
$username = "sql12608164";
$password = "eDcWvKrJUv";
$dbname = "sql12608164";
$conn = new mysqli($servername, $username, $password, $dbname);
$sql = "SELECT * FROM cyber_security_questions";
$result = mysqli_query($conn, $sql);
while ($row = mysqli_fetch_assoc($result)) {
    echo "<div class='questions'><p>" . $row['question'] . "</p></div>";
}
$conn->close();
?>
