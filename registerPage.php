		...
		<div class="signin" style="margin-bottom:4rem">
			...
			<div class="right">
				...
				<form action="" method="post">
					...
					<input type="tel" pattern="[0-9]{10}" id="phone" name="phone" required placeholder="Phone No." autocomplete="off" oninvalid="this.setCustomValidity('Must Be 10 Digits!')" onvalid="this.setCustomValidity('')" /><br />
