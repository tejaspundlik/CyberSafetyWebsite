...
<body>
	...
	<div class="main">
		...
		<div class="donation">
			<h1>Donate Now</h1>
			<p>Donate what you think is a fair amount</p>
			<input placeholder="Amount In Rupees" id="amount" /><br />
			<div style="max-width: 10rem; margin: 0 auto 0 auto">
				<button class="button" id="donationButton">
					<p>Donate</p>
				</button>
			</div>
		</div>
	</div>
	<script src="./DonationBackend/Donation.js"></script>
</body>
